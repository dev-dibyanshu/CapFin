...
public interface ILoanApplicationService
{
    ...
    Task<LoanApplicationResponse> UpdatePersonalDetailsAsync(Guid applicationId, Guid requesterUserId, PersonalDetailsRequest request, CancellationToken cancellationToken = default);
    Task<LoanApplicationResponse> UpdateEmploymentDetailsAsync(Guid applicationId, Guid requesterUserId, EmploymentDetailsRequest request, CancellationToken cancellationToken = default);
    Task<LoanApplicationResponse> UpdateLoanDetailsAsync(Guid applicationId, Guid requesterUserId, LoanDetailsRequest request, CancellationToken cancellationToken = default);
}